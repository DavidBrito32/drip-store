...
const ProductsDashboard = (): JSX.Element => {
  ...
  const toogleProduct = () =>  setFlags({ ...flags, createProduct: !flags.createProduct });
  const toogleEditProduct = () =>  setFlags({ ...flags, editProduct: !flags.editProduct });
  const toogleCategory = () =>  setFlags({ ...flags, createCategory: !flags.createCategory });
  const toogleBrand = () =>  setFlags({ ...flags, createBrand: !flags.createBrand });
  ...
  return (
    <>
      <Container>
        ...
        <CreateProduct state={flags.createProduct} toogle={toogleProduct} />
        <EditProduct
